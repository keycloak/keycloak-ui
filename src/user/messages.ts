export default {
  users: {
    ...
    credentialsResetBtn: "Credentials Reset",
    ...
    minutes: "Minutes",
    seconds: "Seconds",
    credentialsResetConfirm: "Send Email",
    credentialsResetConfirmText: "Are you sure you want to send email to user",
    resetCredentialEmailSuccess: "Email sent to user.",
    resetCredentialEmailError: "Failed to send email to user.",
  },
};
