...
export const UserGroups = ({ onRemove }: UserGroupsTabProps) => {
  ...
  const loader = async (user: UserRepresentation) => {
    if (isDirectMembership) {
      //   return additionalRoles;
    }

    const allGroups = await adminClient.users.listGroups({ id: user.id! });
